...
export function Header() {
  ...
  const menuItems = ['Home', 'Services', 'Technologies', 'Mobile Apps', 'Portfolio', 'Process', 'About', 'Contact'];
      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-11 h-11 bg-gradient-to-br from-purple-600 to-pink-600 rounded-lg flex items-center justify-center shadow-lg shadow-purple-500/30">
