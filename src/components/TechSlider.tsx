...
const TechCard: React.FC<{ tech: TechStack }> = ({ tech }) => (
  <div className={`group relative flex items-center gap-3 px-5 py-3 ${tech.bgColor} backdrop-blur-sm border border-slate-700/50 rounded-xl whitespace-nowrap mx-2 hover:scale-105 ${tech.glowColor} hover:shadow-xl transition-all duration-300 ease-out`}>
    {/* Logo */}
    ...
    {/* Tech name */}
    <span className={`${tech.textColor} font-medium text-sm group-hover:text-blue-200 transition-colors duration-300`}>
      {tech.name}
    </span>
  </div>
);
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-block">
            <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent mb-6 animate-gradient">
        ...
        <div className="space-y-8">
          ...
          <SliderRow techs={firstRow} direction="left" speed={35} />
          
          {/* Second row - moving left to right */}
          <SliderRow techs={secondRow} direction="right" speed={30} />
        </div>
